...
class BERTNERDataset(Dataset):
	...
	def __getitem__(self, item):
		...
		# Tlabel2idx_list = self.args.Tlabel2idx_list
		# for labidx in Tlabel2idx_list:
		# 	lab, idx = labidx
		# 	Tlabel2idx[lab] = int(idx)
	...
	def convert2tokenIdx(self, words, tokens, type_ids, offsets, span_idxs, span_idxLab):
		...
		for start, end in zip(sidxs, eidxs):
			if (start in origin_offset2token_sidx) and (end in origin_offset2token_eidx):
